// Wait for DOM to be fully loaded (cache-bust marker: 20260315)
...
function initChatbot() {
    ...
    const handleSendMessage = async () => {
        ...
        try {
            ...
            const fallbackText = buildChatbotErrorMessage(window.currentLanguage || 'en', fallback);
...
function buildChatbotErrorMessage(lang, fallback) {
    const messages = {
        en: "Sorry, I'm having trouble reaching the AI right now. Here's some info that may help: ",
        ar: "عذرًا، أواجه مشكلة في الوصول إلى الذكاء الاصطناعي الآن. إليك بعض المعلومات التي قد تساعد: ",
        ps: "بښنه غواړم، اوس د AI سره اړیکه نه شم نیولی. دلته ځینې معلومات دي چې مرسته کولی شي: ",
        my: "တောင်းပန်ပါတယ်၊ ယခု AI ကို ဆက်သွယ်ရာမှာ ပြဿနာရှိပါတယ်။ အထောက်အကူဖြစ်နိုင်သော အချက်အလက်များမှာ- "
    };
    const prefix = messages[lang] || messages.en;
